  ...
  links: [
    {
      title: 'Productos',
      links: [
        { text: 'Retiro', href: getPermalink('/developing') },
        { text: 'Terapia individual', href: getPermalink('/developing') },
        { text: 'Terapia para parejas', href: getPermalink('/contact') },
        { text: 'Taller de manifestaciones', href: getPermalink('/developing') },
        { text: 'Taller de emociones', href: getPermalink('/developing') },
        { text: 'Curso de introducción al cerebro', href: getPermalink('/developing') },
        { text: 'Curso de introducción al eneagrama', href: getPermalink('/developing') },
        { text: 'Curso de eneagrama game', href: getPermalink('/developing') },
        { text: 'Curso de introducción a la biodescodificación', href: getPermalink('/developing') },
      ],
    },
    {
      title: 'Empresas',
      links: [
        { text: 'Taller de equipos', href: getPermalink('/developing') },
        { text: 'Conferencias', href: getPermalink('/developing') },
        { text: 'Paquete de consultas', href: getPermalink('/developing') },
      ],
    },
    {
      title: 'Soporte',
      links: [
        ...
        { text: 'Nosotros', href: getPermalink('/developing') },
        { text: 'Blog', href: getPermalink('/developing') },
        { text: 'Servicios Profesionales', href: getPermalink('/developing') },
        { text: 'Impacto Social', href: getPermalink('/developing') },
        { text: 'Tienda', href: getPermalink('/developing') },
